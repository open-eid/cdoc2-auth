...
class AuthTokenVerifierV2Test {
    ...
    void verifyTokenFailWhenUnsupportedTyp() {
        String authToken = new SdJwtWrapper(AUTH_TOKEN_WITH_FILTERED_DISCLOSURES_BASE64URL)
            .replaceValue("typ", "UNKNOWN_TYPE");
    ...
    void verifyTokenFailWhenIssDoesNotStartWithEtsi() {
        String authToken = new SdJwtWrapper(AUTH_TOKEN_WITH_FILTERED_DISCLOSURES_BASE64URL)
            .replaceValue("iss", "PNOEE-40504040001");
